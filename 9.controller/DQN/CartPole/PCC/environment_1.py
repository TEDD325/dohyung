...
MQTT_PUB_TO_SERVO_POWER = 'motor_power_1'
MQTT_PUB_RESET = 'reset_1'
MQTT_SUB_FROM_SERVO = 'servo_info_1'
MQTT_SUB_MOTOR_LIMIT = 'motor_limit_info_1'
MQTT_SUB_RESET_COMPLETE = 'reset_complete_1'
MQTT_ERROR = 'error_1'
...
# balance_motor_power_list = [-60, -30, 0, 30, 60]
...
class Env:
    ...
    def __init__(self):
        ...
        self.reward = 0
        self.UDF_positive_reward = 0.1
        self.UDF_negative_reward = -1
        ...
        self.sub = mqtt.Client(client_id="env_sub_1", transport="TCP")
        ...
        self.pub = mqtt.Client(client_id="env_pub_1", transport="TCP")
    ...
    def step(self, action_index):
        ...
        self.reward = self.UDF_positive_reward
    ...
    def __isDone(self):
        if self.steps >= 5000:# len(self.pendulum_radians) > 500 and abs(np.mean(self.pendulum_radians[-500:])) < 3.14 / 18:
            ...
            self.reward = self.UDF_negative_reward
