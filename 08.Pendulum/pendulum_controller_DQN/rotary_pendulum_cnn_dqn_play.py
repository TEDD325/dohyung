...
class DQNAgent:
    def __init__(self, state_shape, action_size):
        ...
        if os.path.exists("./success/rotary_pendulum.h5"):
            self.load_model = True
            self.memory_load("./success/dqn_memory.pickle")

        if self.load_model:
            self.model.load_weights("./success/rotary_pendulum.h5")
...
if __name__ == "__main__":
    ...
    episode_start_num = 0
    if os.path.exists("./success/last_episode_num.txt"):
        with open("./success/last_episode_num.txt", 'r') as f:
    ...
    for episode in range(episode_start_num, EPISODES):
        ...
        while not done:
            ...
            if done:
                ...
                pylab.savefig("./success/rotary_pendulum_play.png")
