...
public class TestMqttDeviceCommandRec implements MqttCallback {
  ...
  private static String REQ_MQTT_BROKER = "10.0.0.2";//"m13.cloudmqtt.com";
  private static String REQ_MQTT_PROTOCOL = "tcp";
  private static int REQ_MQTT_BROKER_PORT = 1883; //18465
  private static String REQ_MQTT_CLIENT_ID = "OutgoingCommandSubscriber";
  private static String REQ_MQTT_TOPIC = "DataTopic";
  private static String REQ_MQTT_USER = "link"; //"goebqlul";
  private static String REQ_MQTT_PASS = "0123"; //"bUgIzPeyl5d1";

  private static String RESP_MQTT_BROKER = "10.0.0.2";
  private static String RESP_MQTT_PROTOCOL = "tcp";
  private static int RESP_MQTT_BROKER_PORT = 1883;
  private static String RESP_MQTT_CLIENT_ID = "CommandResponsePublisher";
  private static String RESP_MQTT_TOPIC = "ResponseTopic";
  private static String RESP_MQTT_USER = "link";
  private static String RESP_MQTT_PASS = "0123";
  ...
  public void messageArrived(String topic, MqttMessage message) throws Exception {
    MqttMessage payload = new MqttMessage(message.getPayload());
    //String payload = new String(message.getPayload());
    //System.out.println("Red'c command:  " + payload);
    System.out.println("RaspberryPi's msg:  " + payload);
